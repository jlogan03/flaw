...
rust_tables_path = here.parent / "flaw/src/sos/tables/"
max_cutoff = 0.4
sections_and_cutoffs = [
    (1, 0.005, 0.0020),
    (2, 0.005, 0.0005),
    (3, 0.010, 0.0005),
]
for (sections, min_cutoff_f32, min_cutoff_f64) in sections_and_cutoffs:
    order = 2 * sections
    ...
    with open(rust_tables_path / f"butter{order:d}.rs", "w") as rust_source_file:
...
with open(rust_tables_path / "mod.rs", "w") as rust_mod_file:
    rust_mod_file.write("//! Pre-calculated Second Order Sections (SOS) tables for Butterworth filters.\n//! This file is autogenerated.\n\n")

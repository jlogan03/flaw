...
from scipy.signal import butter, dlti, StateSpace, dlsim, dbode
...
modfpath = here / "../flaw/src/generated/butter/mod.rs"
...
for order, min_log10_cutoff in zip(orders, min_log10_cutoffs):
    ...
    with open(outfile, "w") as f:
        ...
        f.write("use crate::{SisoIirFilter, StagedSisoIirFilter};\n\n")

        f.write("/// Minimum tabulated cutoff ratio\n")
        f.write("#[allow(dead_code)]\n")
        f.write(f"pub const MIN_CUTOFF_RATIO: f64 = {float(cutoff_ratios[0])};\n\n")

        f.write("/// Maximum tabulated cutoff ratio\n")
        f.write("#[allow(dead_code)]\n")
...
""")
        ...
        f.write("    Ok(StagedSisoIirFilter::new([filt, filt]))\n")
        f.write("}\n\n")
